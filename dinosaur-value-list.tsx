...
export default function Component() {
  ...
  const tiers: Tier[] = [
    {
      name: "S Tier (110+)",
      range: "110+ (2.2M-11.4M dna)",
      color: "from-red-500 to-pink-600",
      gradient: "bg-gradient-to-br from-red-800/60 to-pink-800/60",
      dinosaurs: [
        { name: "Apparition Fossil Giganotosaurus", value: 570, rarity: "8/8" },
        { name: "Eschaton Argentinosaurus", value: 470, rarity: "8/8" },
        { name: "Pitch Wraith Terror", value: 290, rarity: "8/8" },
        { name: "Pitch Black Sunfish Shonisaurus", value: 220, rarity: "6/8" },
        { name: "Pitch Black Elasmosaurus", value: 210, rarity: "6/8" },
        { name: "Pitch Black Baryonyx", value: 200, rarity: "5/8" },
        { name: "Wraith Terror", value: 190, rarity: "6/8" },
        { name: "Pitchygator", value: 175, rarity: "7/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Reaper Gelioichthys", value: 69, rarity: "6/8" },
        { name: "Pitch Black Terror", value: 67, rarity: "6/7" },
        { name: "Dolphin Ichthyovenator", value: 65, rarity: "6/8" },
        { name: "Aurora Borethalass", value: 62, rarity: "7/8" },
        { name: "Zomvinychus", value: 55, rarity: "6/8" },
        { name: "Pitch Luminescent Avinychus", value: 54, rarity: "5/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Peak Spinosaurus", value: 30, rarity: "6/8" },
        { name: "Carcharocles Megalodon", value: 28, rarity: "6/8" },
        ...
        { name: "Butterfly Alametus", value: 26, rarity: "6/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Rakebaby Guanlong", value: 23, rarity: "4/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Nidhogg", value: 10, rarity: "3/8" },
