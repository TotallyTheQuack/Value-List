  ...
  const tiers: Tier[] = [
    {
      ...
      dinosaurs: [
        ...
        { name: "Wraith Terror", value: 170, rarity: "7/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Blue Whale Shastasaurus", value: 95, rarity: "8/8" },
        { name: "Galactic Barosaurus", value: 80, rarity: "5/8" },
        { name: "Orca Spinosaurus", value: 64, rarity: "6/8" },
        { name: "Reaper Gelioichthys", value: 68, rarity: "6/8" },
        { name: "Pitch Luminescent Avinychus", value: 64, rarity: "5/8" },
        { name: "Distorted King", value: 85, rarity: "6/8" },
        { name: "Dolphin Ichthyovenator", value: 58, rarity: "5/8" },
        { name: "Pitch Black Terror", value: 58, rarity: "6/8" },
        { name: "Luminescent Avinychus", value: 54, rarity: "6/8" },
        { name: "Giant Albino Baryonyx", rarity: "4/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Kaiju Spinofaarus", value: 40, rarity: "5/8" },
        ...
        { name: "Alpha Kaiju Spinosaurus", value: 28, rarity: "4/8" },
        { name: "White Walker Carcharodontosaurus", value: 27, rarity: "4/8" },
        { name: "Classic Megavore", value: 30, rarity: "3/8" },
        { name: "Zomvinychus", value: 95, rarity: "8/8" },
        { name: "Movie Mosasaurus", value: 58, rarity: "6/8" },
        { name: "Crossover Hybrid/Vinera", value: 35, rarity: "4/8" },
      ],
    },
    {
      name: "C Tier",
      ...
      dinosaurs: [
        ...
        { name: "Spawn Shunosaurus", value: 19, rarity: "4/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        { name: "Butterfly Alametus", value: 17, rarity: "4/8" },
        ...
        { name: "Movie Therizinosaurus", value: 12, rarity: "3/8" },
        ...
        { name: "Indomitable King", value: 10, rarity: "4/8" },
      ],
    },
    {
      name: "E Tier",
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <div className="mb-4 sm:mb-6">
          <p className={`${theme.textSecondary} text-sm`}>Showing {filteredAndSortedDinosaurs.length} dinosaurs</p>
        </div>
