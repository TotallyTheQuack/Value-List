...
export default function Component() {
  ...
  const tiers: Tier[] = [
    {
      name: "S Tier (110+)",
      range: "110+ (1M-4.5M dna)",
      color: "from-red-500 to-pink-600",
      gradient: "bg-gradient-to-br from-red-800/60 to-pink-800/60",
      dinosaurs: [
        { name: "Apparition Fossil Giganotosaurus", value: 440, rarity: "8/8" },
        { name: "Eschaton Argentinosaurus", value: 400, rarity: "8/8" },
        { name: "Pitch Wraith Terror", value: 280, rarity: "8/8" },
        { name: "Pitch Black Elasmosaurus", value: 210, rarity: "6/8" },
        { name: "Pitch Black Sunfish Shonisaurus", value: 210, rarity: "6/8" },
        { name: "Pitch Black Baryonyx", value: 200, rarity: "6/8" },
        { name: "Wraith Terror", value: 180, rarity: "6/8" },
        { name: "Hydralania", value: 160, rarity: "6/8" },
        { name: "Violex Magnus", value: 150, rarity: "6/8" },
        { name: "Pitchygator", value: 140, rarity: "7/8" },
        { name: "Blue Whale Shastasaurus", value: 140, rarity: "7/8" },
        { name: "Fallen Gladiator", value: 135, rarity: "7/8" },
        { name: "Distorted King", value: 130, rarity: "7/8" },
        { name: "Berserk Alametus", value: 125, rarity: "6/8" },
        { name: "Isisauriraptor", value: 122, rarity: "6/8" },
        { name: "Pitch Black Moray Oxalaia", value: 120, rarity: "6/8" },
      ],
    },
    {
      name: "A Tier (50-110)",
      range: "50-110 (450K-1.1M dna)",
      ...
      dinosaurs: [
        ...
        { name: "Cathedral Fasolatherium", value: 96, rarity: "6/8" },
        { name: "Orca Spinosaurus", value: 85, rarity: "6/8" },
        { name: "Nameless Barosaurus", value: 75, rarity: "6/8" },
        { name: "Reaper Gelioichthys", value: 72, rarity: "7/8" },
        { name: "Movie Mosasaurus", value: 70, rarity: "7/8" },
        { name: "Pitch Black Terror", value: 70, rarity: "6/8" },
        { name: "Giant Albino Baryonyx", value: 68, rarity: "6/8" },
        { name: "Dolphin Ichthyovenator", value: 65, rarity: "6/8" },
        { name: "Pitch Luminescent Avinychus", value: 60, rarity: "5/8" },
        { name: "Kaiju Giraffatitan", value: 52, rarity: "6/8" },
        { name: "Zomvinychus", value: 52, rarity: "6/8" },
        { name: "Luminescent Avinychus", value: 50, rarity: "5/8" },
      ],
    },
    {
      name: "B Tier (25-49)",
      range: "25-49 (250K-540K dna)",
      color: "from-yellow-500 to-orange-500",
      gradient: "bg-gradient-to-br from-yellow-800/60 to-orange-800/60",
      dinosaurs: [
        { name: "Aurora Borethalass", value: 49, rarity: "6/8" },
        { name: "Pitch Coconut Brachiosaurus", value: 42, rarity: "4/8" },
        { name: "Scylla", value: 38, rarity: "5/8" },
        { name: "Kaiju Spinofaarus", value: 36, rarity: "5/8" },
        { name: "Spinofaarus", value: 35, rarity: "5/8" },
        ...
        { name: "Peak Spinosaurus", value: 30, rarity: "5/8" },
        { name: "Early Winter Frost Sauroposeidon", value: 28, rarity: "4/8" },
        { name: "Spectre Fossil Megavore", value: 28, rarity: "4/8" },
        { name: "Reindeer Istiodactylus", value: 27, rarity: "3/8" },
        { name: "Forgotten Mutant", value: 26, rarity: "5/8" },
        { name: "Butterfly Alametus", value: 26, rarity: "5/8" },
      ],
    },
    {
      name: "C Tier (15-25)",
      range: "15-25 (150K-275K dna)",
      color: "from-green-500 to-yellow-500",
      gradient: "bg-gradient-to-br from-green-800/60 to-yellow-800/60",
      dinosaurs: [
        { name: "Toy Train Mastodonsaurus", value: 25, rarity: "5/8" },
        { name: "Carcharocles Megalodon", value: 25, rarity: "5/8" },
        { name: "Alpha Kaiju Spinosaurus", value: 25, rarity: "5/8" },
        { name: "Disco Stegosaurus", value: 25, rarity: "4/8" },
        { name: "Pitch Black Apatosaurus", value: 25, rarity: "4/8" },
        { name: "Spawn Shunosaurus", value: 24, rarity: "5/8" },
        { name: "Kaiju Gelioichthys", value: 24, rarity: "5/8" },
        { name: "White Walker Carcharodontosaurus", value: 24, rarity: "4/8" },
        { name: "Rakebaby Guanlong", value: 24, rarity: "4/8" },
        { name: "Pitch Black Dolichomalosaurus", value: 23, rarity: "4/8" },
        { name: "Masquerade Gigantoraptor", value: 22, rarity: "4/8" },
        ...
        { name: "Spring Blossom Lusotitan", value: 18, rarity: "3/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Movie Spinosaurus", value: 11, rarity: "3/8" },
        { name: "Chaos Titanosaur", value: 11, rarity: "3/8" },
        { name: "Kaiju Sauroposeidon", value: 11, rarity: "3/8" },
        { name: "Cozy Cabin Argentinosaurus", value: 10, rarity: "3/8" },
        { name: "Snowflake Stegosaurus", value: 10, rarity: "2/8" },
      ],
    },
    {
      name: "E Tier (4-9)",
      range: "4-9 (40K-90K dna)",
      ...
      dinosaurs: [
        ...
        { name: "Nidhogg Purrrusaurus", value: 8, rarity: "3/8" },
        { name: "Saurophaganax Remodel", value: 8, rarity: "3/8" },
        { name: "Singulafaarus", value: 8, rarity: "3/8" },
        ...
        { name: "Violex Parvulus", value: 8, rarity: "2/8" },
        ...
        { name: "Indomitable Thief", value: 6, rarity: "2/8" },
        ...
        { name: "Pumpkin Megalodon", value: 5, rarity: "1/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        { name: "Branded Purrusaurus", value: "2300-2600", rarity: "1/8" },
        { name: "Metron Praenintius", value: "1400-1600", rarity: "5/8" },
        ...
        { name: "Diamond Tusoteuthis", value: 10, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Diamond Acrocanthosaurus", value: 10, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Diamond Shunosaurus", value: 10, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Diamond Maiasaurus", value: 10, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Diamond Styracosaurus", value: 10, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Diamond Pteranodon", value: 10, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Diamond Thalassodromeus", value: 10, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Diamond Parasaurolophus", value: 10, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Diamond Concavenator", value: 10, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Diamond Gojirasaurus", value: 10, rarity: "1/8", sdna: "250 SDNA" },
      ],
    },
    {
      name: "Throwbacks",
    ...
    },
    {
      ...
      dinosaurs: [
        { name: "Diamond Albino Terror", value: 6, rarity: "2/8", sdna: "250 SDNA" },
        { name: "Diamond Megavore", value: 6, rarity: "2/8", sdna: "250 SDNA" },
        { name: "Rainbow Albino Terror", value: 6, rarity: "2/8", sdna: "50 SDNA" },
        { name: "Rainbow Megavore", value: 6, rarity: "2/8", sdna: "50 SDNA" },
        { name: "Diamond Barosaurus", value: 5, rarity: "1/8", sdna: "250 SDNA" },
        { name: "Rainbow Barosaurus", value: 2, rarity: "1/8", sdna: "50 SDNA" },
        { name: "Inverted Albino Terror", value: 0, rarity: "8/8" },
        { name: "Inverted Alametus", value: 0, rarity: "8/8" },
        { name: "Inverted Megavore", value: 0, rarity: "7/8" },
        { name: "Inverted Fasolatherium", value: 0, rarity: "6/8" },
        { name: "Inverted Gelioichthys", value: 0, rarity: "6/8" },
        { name: "Inverted Dolichomalasaurus", value: 0, rarity: "6/8" },
        { name: "Inverted Mayhem Tripod", value: 0, rarity: "5/8" },
        { name: "Inverted Mayhem Excavator", value: 0, rarity: "4/8" },
        { name: "Inverted Argentinosaurus", value: 0, rarity: "4/8" },
        { name: "Inverted Carcharocles Megalodon", value: 0, rarity: "4/8" },
        { name: "Inverted Purussaurus", value: 0, rarity: "4/8" },
        { name: "Inverted Mayhem Wanderer", value: 0, rarity: "3/8" },
        { name: "Inverted Maip Machothorax", value: 0, rarity: "3/8" },
        { name: "Inverted Avinychus", value: 0, rarity: "3/8" },
        { name: "Inverted Mayhem Crawler", value: 0, rarity: "2/8" },
        { name: "ALL Glass skins", value: 0.25, rarity: "1/8", sdna: "20 SDNA" },
      ],
    },
    {
      name: "Gamepasses",
      ...
      dinosaurs: [
        ...
        { name: "Permian Excavator", value: 4, rarity: "1/8", sdna: "SDNA" },
        { name: "Ultimallosaurus", value: 2, rarity: "1/8", sdna: "SDNA" },
        { name: "Apex Hothead Megavore", value: 2, rarity: "1/8", sdna: "SDNA" },
        { name: "Solar Bringer Megavore", value: 0.5, rarity: "1/8", sdna: "SDNA" },
        { name: "Deep Sea Megavore", value: 0.5, rarity: "1/8", sdna: "SDNA" },
        { name: "Zweinova-Blank", value: 7.5, rarity: "2/8", sdna: "Monster Madness Survival" },
        { name: "Zenova", value: 5, rarity: "2/8", sdna: "Monster Madness Survival" },
        { name: "Dimension Beast", value: 5, rarity: "1/8", sdna: "Monster Madness Survival" },
        { name: "Withered Willow Futalognkosaurus", value: 0, rarity: "1/8", sdna: "Halloween 2020" },
        { name: "Crow Istiodactylus", value: 0, rarity: "1/8", sdna: "Halloween 2020" },
        { name: "Raven Hatzegopteryx", value: 0, rarity: "1/8", sdna: "Halloween 2020" },
        { name: "Wyvern", value: 0, rarity: "1/8", sdna: "Code" },
        { name: "Yutashu", value: 0, rarity: "1/8", sdna: "Code" },
      ],
    },
  ]
