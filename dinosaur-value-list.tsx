...
export default function Component() {
  ...
  const tiers: Tier[] = [
    ...
    },
    {
      ...
      color: "bg-cyan-500",
      dinosaurs: [
        { name: "Wyvern", value: "0", rarity: "1/8", code: "Pokemantrainer" },
        { name: "Yutashu", value: "0", rarity: "1/8", code: "Burnt Burrito" },
      ],
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Pitch Wraith Terror", value: 190, rarity: "5/8" },
        { name: "Hydralania", value: 170, rarity: "7/8" },
        { name: "Fallen Gladiator", value: 140, rarity: "8/8" },
        { name: "Violex Magnus", value: 140, rarity: "8/8" },
        { name: "Wraith Terror", value: 140, rarity: "5/8" },
        { name: "Isisauriraptor", value: 130, rarity: "6/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Blue Whale Shastasaurus", value: 85, rarity: "5/8" },
        { name: "Galactic Barosaurus", value: 90, rarity: "7/8" },
        { name: "Orca Spinosaurus", value: 70, rarity: "4/8" },
        { name: "Reaper Gelioichthys", value: 68, rarity: "6/8" },
        { name: "Pitch Luminescent Avinychus", value: 68, rarity: "5/8" },
        { name: "Distorted King", value: 60, rarity: "5/8" },
        { name: "Dolphin Ichthyovenator", value: 55, rarity: "4/8" },
    ...
    },
    {
      ...
      color: "bg-yellow-500",
      dinosaurs: [
        { name: "Aurora Borethalass", value: 48, rarity: "5/8" },
        ...
        { name: "Zomvinychus", value: 44, rarity: "6/8" },
        ...
        { name: "Peak Spinosaurus", value: 34, rarity: "3/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Movie Mosasaurus", value: 22, rarity: "3/8" },
        { name: "Firebird", value: 26, rarity: "6/8" },
        { name: "Rakebaby Guanlong", value: 24, rarity: "5/8" },
        { name: "Toy Train Mastodonsaurus", value: 23, rarity: "5/8" },
        { name: "Movie Spinosaurus", value: 22, rarity: "3/8" },
        ...
        { name: "Carcharocles Megalodon", value: 20, rarity: "5/8" },
    ...
    },
    {
      ...
      color: "bg-purple-500",
      dinosaurs: [
        { name: "Chaos Spinosaurus", value: 9, rarity: "3/8" },
        ...
        { name: "Spring Blossom Lusotitan", value: 6, rarity: "2/8" },
    ...
    },
    {
      ...
      color: "bg-gray-500",
      dinosaurs: [
        { name: "Branded Purrusaurus", value: 1350, rarity: "1/8" },
        { name: "Golden Ectenosaurus", value: "100-170", rarity: "1/8" },
        { name: "Crossover Hybrid/Vinera", value: 45, rarity: "4/8" },
        ...
        { name: "Grayscale Megavore", value: 85, rarity: "1/8" },
        { name: "Grayscale Dolichomalosaurus", value: 60, rarity: "1/8" },
        { name: "Grayscale Avinychus", value: 60, rarity: "1/8" },
        { name: "Grayscale Alametus", value: 48, rarity: "1/8" },
      ],
      isOpen: openTiers["Collectors' Tier"],
    },
  ]
