...
export default function Component() {
  ...
  const tiers: Tier[] = [
    ...
    },
    {
      ...
      dinosaurs: [
        // Green - <=1%
        { name: "Grayscale Megavore", value: 10, rarity: "2/8" },
        { name: "Grayscale Albino Terror", value: 10, rarity: "2/8" },
        { name: "Grayscale Alametus", value: 10, rarity: "2/8" },
        { name: "Grayscale Dolichomalosaurus", value: 8, rarity: "2/8" },
        { name: "Grayscale Fasolatherium", value: 8, rarity: "2/8" },
        { name: "Grayscale Avinychus", value: 5, rarity: "2/8" },
        { name: "Grayscale Gelioichthys", value: 5, rarity: "2/8" },
        // Purple - 0.5-1%
    ...
    },
    {
      ...
      color: "bg-red-500",
      dinosaurs: [
        { name: "Metron Praenintius", value: 1750, rarity: "8/8" },
        { name: "Pitch Wraith Terror", value: 390, rarity: "7/8" },
        { name: "Wraith Terror", value: 285, rarity: "7/8" },
        { name: "Hydralania", value: 205, rarity: "7/8" },
        { name: "Blue Whale Shastasaurus", value: 170, rarity: "5/8" },
        { name: "Isisauriraptor", value: 180, rarity: "8/8" },
        { name: "Berserk Alametus", value: 170, rarity: "8/8" },
      ],
    ...
    },
    {
      ...
      color: "bg-orange-500",
      dinosaurs: [
        { name: "Violex Magnus", value: 100, rarity: "7/8" },
        { name: "Galactic Barosaurus", value: 110, rarity: "6/8" },
        { name: "Megavore", value: 100, rarity: "8/8" },
        { name: "Albino Terror", value: 95, rarity: "8/8" },
        { name: "Fallen Gladiator", value: 105, rarity: "8/8" },
        { name: "Orca Spinosaurus", value: 95, rarity: "4/8" },
        { name: "Pitch Luminescent Avinychus", value: 70, rarity: "5/8" },
        { name: "Dolphin Ichthyovenator", value: 70, rarity: "4/8" },
        { name: "Reaper Gelioichthys", value: 68, rarity: "7/8" },
        { name: "Luminescent Avinychus", value: 56, rarity: "6/8" },
        { name: "Giant Albino Baryonyx", value: 54, rarity: "6/8" },
        { name: "Pitch Black Terror", value: 52, rarity: "6/8" },
      ],
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Zomvinychus", value: 45, rarity: "6/8" },
        { name: "Classic Pitch Black Terror", value: 40, rarity: "3/8" },
        { name: "Alien Irritator", value: 38, rarity: "3/8" },
        { name: "Peak Spinosaurus", value: 37, rarity: "3/8" },
        { name: "Spinofaarus", value: 34, rarity: "5/8" },
        { name: "Pitch Coconut Brachiosaurus", value: 36, rarity: "4/8" },
        { name: "Classic Albino Terror", value: 32, rarity: "3/8" },
        { name: "Kaiju Spinofaarus", value: 34, rarity: "6/8" },
        { name: "Scylla", value: 40, rarity: "6/8" },
    ...
    },
    {
      ...
      color: "bg-green-500",
      dinosaurs: [
        { name: "Disco Stegosaurus", value: 28, rarity: "4/8" },
        ...
        { name: "Krampus", value: 18, rarity: "4/8" },
        { name: "Santa Clawz", value: 16, rarity: "2/8" },
        { name: "Movie Spinosaurus", value: 13, rarity: "3/8" },
      ],
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Kaiju Gelioichthys", value: 13, rarity: "5/8" },
    ...
    },
    {
      ...
      color: "bg-gray-500",
      dinosaurs: [
        { name: "Branded Purrusaurus", value: "2000-2500", rarity: "2/8" },
        { name: "Golden Ectenosaurus", value: "80-150", rarity: "1/8" },
        { name: "Crossover Hybrid/Vinera", value: "40-60", rarity: "3/8" },
