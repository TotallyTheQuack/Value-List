...
export default function Component() {
  ...
  const tiers: Tier[] = [
    ...
    },
    {
      ...
      dinosaurs: [
        // Green - <=1%
        { name: "Grayscale Megavore", value: 6, rarity: "2/8" },
        { name: "Grayscale Albino Terror", value: 6, rarity: "2/8" },
        { name: "Grayscale Alametus", value: 6, rarity: "2/8" },
        { name: "Grayscale Dolichomalosaurus", value: 6, rarity: "2/8" },
        { name: "Grayscale Fasolatherium", value: 6, rarity: "2/8" },
    ...
    },
    {
      ...
      color: "bg-red-500",
      dinosaurs: [
        { name: "Metron Praenintius", value: 1500, rarity: "6/8" },
        { name: "Pitch Wraith Terror", value: 420, rarity: "7/8" },
        { name: "Wraith Terror", value: 285, rarity: "7/8" },
        { name: "Hydralania", value: 255, rarity: "8/8" },
        { name: "Blue Whale Shastasaurus", value: 190, rarity: "5/8" },
        { name: "Isisauriraptor", value: 160, rarity: "7/8" },
        { name: "Berserk Alametus", value: 155, rarity: "7/8" },
      ],
    ...
    },
    {
      ...
      color: "bg-orange-500",
      dinosaurs: [
        { name: "Violex Magnus", value: 105, rarity: "8/8" },
        { name: "Galactic Barosaurus", value: 105, rarity: "6/8" },
        { name: "Megavore", value: 100, rarity: "8/8" },
        { name: "Albino Terror", value: 95, rarity: "8/8" },
        { name: "Fallen Gladiator", value: 95, rarity: "7/8" },
        { name: "Orca Spinosaurus", value: 95, rarity: "4/8" },
        { name: "Pitch Luminescent Avinychus", value: 72, rarity: "5/8" },
        ...
        { name: "Pitch Black Terror", value: 50, rarity: "7/8" },
      ],
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Zomvinychus", value: 40, rarity: "6/8" },
        ...
        { name: "Classic Albino Terror", value: 35, rarity: "3/8" },
        { name: "Kaiju Spinofaarus", value: 34, rarity: "6/8" },
        { name: "Scylla", value: 31, rarity: "6/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Krampus", value: 16, rarity: "4/8" },
        { name: "Santa Clawz", value: 16, rarity: "2/8" },
        { name: "Movie Spinosaurus", value: 15, rarity: "4/8" },
      ],
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Kaiju Gelioichthys", value: 13, rarity: "3/8" },
        ...
        { name: "Saurophaganax Remodel", value: 12, rarity: "3/8" },
        ...
        { name: "Singularfaarus", value: 10, rarity: "3/8" },
