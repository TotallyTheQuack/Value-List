...
export default function Component() {
  ...
  const tiers: Tier[] = [
    ...
    },
    {
      ...
      dinosaurs: [
        // Updated values
        { name: "Grayscale Megavore", value: 28, rarity: "2/8" },
        { name: "Grayscale Gelioichthys", value: 28, rarity: "2/8" },
        { name: "Grayscale Albino Terror", value: 22, rarity: "2/8" },
        { name: "Grayscale Alametus", value: 20, rarity: "2/8" },
        { name: "Grayscale Fasolatherium", value: 20, rarity: "2/8" },
        { name: "Grayscale Dolichomalosaurus", value: 16, rarity: "2/8" },
        { name: "Grayscale Avinychus", value: 15, rarity: "2/8" },
        // Purple - 0.5-1%
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Pitch Wraith Terror", value: 380, rarity: "7/8" },
        { name: "Wraith Terror", value: 285, rarity: "7/8" },
        { name: "Hydralania", value: 190, rarity: "6/8" },
        { name: "Isisauriraptor", value: 180, rarity: "8/8" },
        { name: "Berserk Alametus", value: 170, rarity: "8/8" },
        { name: "Blue Whale Shastasaurus", value: 120, rarity: "5/8" },
        { name: "Distorted King", value: 115, rarity: "6/8" },
        { name: "Violex Magnus", value: 110, rarity: "7/8" },
      ],
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Galactic Barosaurus", value: 98, rarity: "6/8" },
        { name: "Crossover Hybrid/Vinera", value: 95, rarity: "6/8" },
        { name: "Fallen Gladiator", value: 105, rarity: "8/8" },
        { name: "Orca Spinosaurus", value: 85, rarity: "4/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Scylla", value: 45, rarity: "6/8" },
        { name: "Zomvinychus", value: 42, rarity: "5/8" },
        { name: "Spinofaarus", value: 40, rarity: "6/8" },
        { name: "Classic Pitch Black Terror", value: 40, rarity: "3/8" },
        { name: "Forgotten Mutant", value: 38, rarity: "5/8" },
        ...
        { name: "Movie Spinosaurus", value: 32, rarity: "7/8" },
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Chaos Titanosaur", value: 28, rarity: "5/8" },
        ...
        { name: "Kralkatorrik", value: 20, rarity: "2/8" },
        ...
        { name: "Spawn Shunosaurus", value: 16, rarity: "4/8" },
      ],
    ...
    },
    {
      ...
      dinosaurs: [
        ...
        { name: "Movie Velociraptor", value: "3", rarity: "2/8" },
